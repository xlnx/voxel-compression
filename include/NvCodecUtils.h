...
inline bool check(NVENCSTATUS e, int iLine, const char *szFile) {
    ...
    if (e != NV_ENC_SUCCESS) {
		vm::eprintln("FATAL: NVENC error {} at line {} in file {}",
					 aszErrName[e], iLine, szFile);
        return false;
    }
    return true;
}
...
inline bool check(HRESULT e, int iLine, const char *szFile) {
    if (e != S_OK) {
		vm::eprintln("FATAL: HRESULT error {} at line {} in file {}",
					 (void*)e, iLine, szFile);
        return false;
    }
    return true;
...
inline bool check(GLenum e, int iLine, const char *szFile) {
    if (e != 0) {
		vm::eprintln("FATAL: GLenum error {} at line {} in file {}",
					 e, iLine, szFile);
        return false;
    }
    return true;
